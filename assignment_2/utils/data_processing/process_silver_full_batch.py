...
def main(bronze_manifest):
    ...
    # elif isinstance(obj, dict) and 'bronze_manifest' in obj:
    #     print("bronze_manifest is a dict with 'bronze_manifest' key")
    #     bronze_config = obj['bronze_manifest']
    # else:
    #     print("bronze_manifest is a dict or list without 'bronze_manifest' key")
    #     bronze_config = obj
...
if __name__ == "__main__":
    ...
    silver_config = main(args.bronze_manifest)
